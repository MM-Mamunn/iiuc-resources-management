...
function EditDetails() {
  ...
  const fetchProfileStats = useCallback(async () => {
    ...
    try {
      const response = await api.get("/api/resources/mine/stats");
      setProfileStats(normalizeProfileStats(response.data));
    } catch {
      ...
      <PageShell className="py-10">
        ...
        {loading ? (
          ...
          <>
            ...
            <ProfileStatsSection stats={profileStats} loading={profileStatsLoading} />
  ...
  return (
    <section className="surface-card overflow-hidden">
      <div className="grid gap-6 p-5 sm:p-6 lg:grid-cols-[auto_minmax(0,1fr)_auto] lg:items-center">
        <span className="flex h-36 w-36 items-center justify-center overflow-hidden rounded-full bg-slate-950 text-4xl font-black text-white ring-4 ring-white shadow-sm dark:bg-white dark:text-slate-950 dark:ring-slate-900">
        ...
        <div className="min-w-0">
          ...
          <div className="mt-5 grid gap-3 text-sm sm:grid-cols-2">
            <ProfileMetaItem
              icon={<FiHash className="h-5 w-5" aria-hidden="true" />}
              label="ID"
...
function ProfileMetaItem({ icon, label, value }) {
  return (
    <div className="flex min-w-0 items-center gap-3">
      <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-slate-100 text-slate-600 dark:bg-slate-900 dark:text-slate-300">
        {icon}
      </span>
      <div className="min-w-0">
        ...
        <p className="safe-text mt-0.5 text-sm font-bold text-slate-950 dark:text-white">
          {value || "N/A"}
        </p>
      </div>
    </div>
...
function ProfileStatsSection({ stats, loading }) {
    ...
    <section className="surface-card mt-6 p-5">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        <SectionHeading
          ...
          description="A quick view of your shared resources and the ratings they have received."
        />
      ...
      <div className="mt-5 grid gap-4 xl:grid-cols-[minmax(0,0.95fr)_minmax(0,1.45fr)]">
        <div className="grid gap-3 sm:grid-cols-2">
          <ProfileStatCard
            ...
            tooltip="Total resources you have shared from your account."
          />
          <ProfileStatCard
          ...
          <ProfileStatCard
            ...
            tooltip="Sum of positive aggregate star values from your resources."
          />
          <ProfileStatCard
            icon={<FiStar aria-hidden="true" />}
