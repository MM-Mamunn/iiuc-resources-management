...
} from "../components/profileResourceStatsUtils";
...
const clearPublicDiscoveryCaches = () => {
  clearCacheByPrefix("home:platform-analytics");
      ...
      <PageShell className="py-10">
        ...
        {loading ? (
          ...
          <>
            ...
            <ProfileResourceStats stats={profileStats} loading={profileStatsLoading} />
